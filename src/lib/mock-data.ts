...
export const PARTNERS: Partner[] = [
  {
    ...
    city: "Mumbai",
    country: "India",
    bio: "20+ years in enterprise expansion across APAC. Former Director at Tata Consultancy.",
    tier: "Partner",
    commissionRate: 12,
    status: "Active",
    assignedContact: "Marcus Reid",
    joinedDate: "2024-03-12",
  },
  {
    id: "p2",
    name: "Daniel Okafor",
    email: "daniel@lagoscapital.co",
    phone: "+234 802 555 0199",
    linkedin: "linkedin.com/in/danielokafor",
    city: "Lagos",
    country: "Nigeria",
    bio: "Investment banker turned market-entry consultant for West Africa.",
    tier: "Specialist",
    commissionRate: 10,
    status: "Active",
    assignedContact: "Marcus Reid",
  ...
  },
  {
    ...
    email: "sofia@adriatic-partners.eu",
    phone: "+39 02 9876 5432",
    linkedin: "linkedin.com/in/sofiamarchetti",
    city: "Milan",
    country: "Italy",
    bio: "EU market specialist with deep manufacturing network.",
    tier: "Partner",
    commissionRate: 12,
    status: "Active",
    assignedContact: "Alexandra Pierce",
    joinedDate: "2024-01-18",
  },
  {
    id: "p4",
    name: "Hiroshi Tanaka",
    email: "h.tanaka@tokyobridge.jp",
    phone: "+81 3 5555 1212",
    linkedin: "linkedin.com/in/hiroshitanaka",
    city: "Tokyo",
    country: "Japan",
    bio: "Bridges Western tech firms with Japanese enterprises.",
    tier: "Specialist",
    commissionRate: 10,
    status: "Active",
    assignedContact: "Marcus Reid",
  ...
  },
  {
    id: "p5",
    name: "Isabella Cruz",
    email: "isabella@latambridge.mx",
    phone: "+52 55 1234 5678",
    linkedin: "linkedin.com/in/isabellacruz",
    city: "Mexico City",
    country: "Mexico",
    bio: "LATAM market entry advisor.",
    tier: "Associate",
    commissionRate: 8,
    status: "Active",
    assignedContact: "Marcus Reid",
  ...
  },
  {
    id: "p6",
    name: "Oliver Bennett",
    email: "oliver@thamesgrowth.uk",
    phone: "+44 20 7946 0001",
    linkedin: "linkedin.com/in/oliverbennett",
    city: "London",
    country: "United Kingdom",
    bio: "UK and EU scale-up advisor.",
    tier: "Partner",
    commissionRate: 12,
    status: "Active",
    assignedContact: "Alexandra Pierce",
  ...
  },
  {
    id: "p7",
    name: "Amelia Nguyen",
    email: "amelia@saigonventures.vn",
    phone: "+84 28 3822 9999",
    linkedin: "linkedin.com/in/amelianguyen",
    city: "Ho Chi Minh City",
    country: "Vietnam",
    bio: "SEA expansion specialist focused on D2C and SaaS.",
    tier: "Specialist",
    commissionRate: 10,
    status: "Active",
    assignedContact: "Marcus Reid",
  ...
  },
  {
    id: "p8",
    name: "Lukas Weber",
    email: "lukas@dachadvisory.de",
    phone: "+49 30 5557 8800",
    linkedin: "linkedin.com/in/lukasweber",
    city: "Berlin",
    country: "Germany",
    bio: "DACH region enterprise sales veteran.",
    tier: "Associate",
    commissionRate: 8,
    status: "Pending",
    assignedContact: "Marcus Reid",
  ...
  },
  {
    ...
    email: "fatima@gulfbridge.ae",
    phone: "+971 4 555 7700",
    linkedin: "linkedin.com/in/fatimaalmansouri",
    city: "Dubai",
    country: "UAE",
    bio: "GCC partner with deep government and family-office network.",
    tier: "Partner",
    commissionRate: 13,
    status: "Active",
    assignedContact: "Alexandra Pierce",
  ...
  },
  {
    id: "p10",
    name: "Carlos Mendes",
    email: "carlos@iberiapartners.pt",
    phone: "+351 21 555 4400",
    linkedin: "linkedin.com/in/carlosmendes",
    city: "Lisbon",
    country: "Portugal",
    bio: "Iberian and LATAM cross-border specialist.",
    tier: "Associate",
    commissionRate: 8,
    status: "Suspended",
    assignedContact: "Marcus Reid",
...
export const COMMISSIONS: Commission[] = LEADS.filter((l) => l.stage === "Closed Won").map(
  (l, i) => {
...
export const PAYOUTS: Payout[] = [
  {
    id: "PO-3001",
    partnerId: "p1",
    commissionIds: ["C-2000"],
    amount: 43200,
    status: "Paid",
    requestedDate: "2025-04-12",
    paidDate: "2025-04-20",
    method: "Bank Transfer",
    reference: "TXN-998812",
  },
  {
    id: "PO-3002",
    partnerId: "p3",
    commissionIds: ["C-2001"],
    amount: 16200,
    status: "Pending",
    requestedDate: "2025-06-01",
    message: "Please process this month if possible.",
  },
  {
    id: "PO-3003",
    partnerId: "p6",
    commissionIds: ["C-2002"],
    amount: 28800,
    status: "Approved",
  ...
  },
  {
    id: "PO-3004",
    partnerId: "p9",
    commissionIds: ["C-2003"],
    amount: 62400,
    status: "Rejected",
    requestedDate: "2025-05-22",
    rejectReason: "Client payment not yet received.",
  },
  {
    id: "PO-3005",
    partnerId: "p1",
...
export const CLIENT_PAYMENTS: ClientPayment[] = LEADS.filter((l) => l.stage === "Closed Won")
  .slice(0, 3)
  .map((l, i) => ({
    id: `CP-${4000 + i}`,
    leadId: l.id,
...
export const DISCOVERY_CALLS: DiscoveryCall[] = [
  {
    ...
    duration: 45,
    attendees: "Marcus Reid, Alexandra Pierce",
    clientAttendees: "Dr. Ngozi Eze, CFO",
    partnerJoined: true,
    summary: "Walked through GTPP framework and identified two pilot regions.",
    outcomes: "Pilot scoping aligned. Budget confirmed up to $350k.",
    nextSteps: "Send proposal by June 22.",
    followUp: "2025-06-22",
    attachmentName: "Discovery-notes-Catalyst.pdf",
    private: false,
  },
  {
    id: "DC-5002",
    leadId: "L-1005",
    date: "2025-06-12T10:30",
    duration: 30,
    attendees: "Marcus Reid",
    clientAttendees: "Lars Holm",
    partnerJoined: false,
    summary: "Initial fit assessment.",
    outcomes: "Strong alignment.",
  ...
  },
  {
    ...
    duration: 60,
    attendees: "Alexandra Pierce, Marcus Reid",
    clientAttendees: "Walter Kim, COO",
    partnerJoined: true,
    summary: "Internal-only call notes.",
    outcomes: "Procurement concerns flagged.",
    nextSteps: "Internal review.",
    followUp: "2025-06-25",
    private: true,
  },
];
...
export const ACTIVITY: ActivityEntry[] = [
  {
    ...
    type: "stage_change",
    user: "Marcus Reid",
    text: "Stage changed from New Lead → In Conversation",
    date: "2025-06-19T09:12",
  },
  {
    id: "A2",
    leadId: "L-1000",
    type: "comment",
    user: "Marcus Reid",
    text: "Spoke with Walter. Strong interest, sending materials.",
    date: "2025-06-19T11:30",
  },
  {
    id: "A3",
    leadId: "L-1002",
    type: "discovery_call",
    user: "Marcus Reid",
    text: "Discovery call logged (45 min)",
  ...
  },
  {
    ...
    type: "partner_update",
    user: "Isabella Cruz",
    text: "Anika confirmed timeline pushed by 2 weeks.",
    date: "2025-06-18T08:00",
  },
  {
    id: "A5",
    leadId: "L-1006",
    type: "stage_change",
    user: "Marcus Reid",
    text: "Moved to Proposal Sent",
    date: "2025-06-17T14:22",
  },
  {
    id: "A6",
    leadId: "L-1010",
    type: "admin_note",
    user: "Marcus Reid",
    text: "Private: procurement red-flags.",
    date: "2025-06-16T13:00",
    private: true,
  },
  {
    id: "A7",
    ...
    text: "Uploaded RFP-PalmaResorts.pdf",
  ...
  },
  {
    ...
    type: "system",
    user: "System",
    text: "Lead flagged as stale (21+ days inactive)",
  ...
  },
  {
    ...
    type: "status_change",
    user: "Marcus Reid",
    text: "Status changed to Disqualified",
  ...
  },
  {
    ...
    type: "system",
    user: "System",
    text: "Duplicate flagged for review",
...
export const ANNOUNCEMENTS: Announcement[] = [
  {
    id: "AN-1",
    title: "Q3 Commission Bonus Program Launched",
    body: "All Partner-tier sales partners now eligible for an additional 2% milestone bonus on deals closed in Q3. See updated terms in the partner agreement.",
    priority: "Important",
    target: "All partners",
    date: "2025-06-15",
    readBy: ["p2", "p3"],
  ...
  {
    id: "AN-2",
    title: "New Industry Vertical: Climate Tech",
    body: "GoAccelovate is expanding into Climate Tech. Partners with relevant networks should flag opportunities through the standard lead submission flow.",
    priority: "General",
    target: "All partners",
    date: "2025-06-10",
    readBy: ["p1", "p2", "p3", "p6"],
  ...
  {
    id: "AN-3",
    title: "Mandatory: Updated Onboarding Compliance",
    body: "All partners must re-acknowledge the updated Compliance Addendum by July 1. Failure to acknowledge will pause new lead submissions.",
    priority: "Urgent",
    target: "All partners",
    date: "2025-06-01",
    readBy: ["p3", "p6", "p9"],
  ...
  {
    id: "AN-4",
    title: "APAC Regional Enablement Session",
    body: "Next enablement webinar for APAC partners is scheduled for July 8 at 10:00 SGT.",
    priority: "General",
    target: "APAC region",
    date: "2025-05-28",
    readBy: ["p1", "p4", "p7"],
...
export const NOTIFICATIONS: Notification[] = [
  {
    id: "N1",
    title: "Payout PO-3002 submitted",
    body: "Sofia Marchetti requested a payout of $16,200.",
    date: "2025-06-19T09:00",
    read: false,
    type: "info",
  },
  {
    id: "N2",
    title: "Lead flagged as duplicate",
    body: "MontBlanc Insurance may already exist.",
  ...
  },
  {
    ...
    body: "Kestrel Aviation marked Closed Won by Marcus Reid.",
    date: "2025-06-17T10:00",
    read: true,
    type: "success",
  },
  {
    ...
    body: "Q3 Commission Bonus Program Launched",
  ...
  },
  {
    id: "N5",
    title: "Lead stale",
    body: "UrbanMove Mobility has had no activity in 21 days.",
    date: "2025-06-12T00:00",
    read: false,
    type: "warning",
  },
  {
    id: "N6",
    title: "Mandatory payout alert",
    body: "Payout confirmations and account changes are always sent.",
    date: "2025-06-10T08:30",
    read: true,
    type: "info",
    mandatory: true,
  },
...
export const AUDIT_LOG: AuditEntry[] = [
  {
    ...
    module: "Leads",
    date: "2025-06-19T11:30",
    details: "Lead L-1000 stage updated",
    oldValue: "New Lead",
  ...
  },
  {
    ...
    module: "Commissions",
    date: "2025-06-18T15:00",
    details: "Override applied to C-2002",
    oldValue: "12%",
    newValue: "13%",
  },
  {
    ...
    module: "Payouts",
    date: "2025-06-17T09:30",
    details: "PO-3003 approved",
  },
  {
    id: "AU-4",
    user: "Alexandra Pierce",
    action: "Role Change",
    module: "Users",
    date: "2025-06-15T13:00",
    details: "Daniel Okafor role updated",
    oldValue: "Associate",
    newValue: "Specialist",
  },
  {
    ...
    module: "Settings",
    date: "2025-06-14T10:00",
    details: "Lead staleness threshold changed",
    oldValue: "14 days",
    newValue: "21 days",
  },
  {
    ...
    details: "Carlos Mendes account suspended",
  },
  {
    id: "AU-7",
    user: "Marcus Reid",
    ...
    date: "2025-06-11T11:00",
    details: "$240,000 recorded against L-1000",
  },
];
